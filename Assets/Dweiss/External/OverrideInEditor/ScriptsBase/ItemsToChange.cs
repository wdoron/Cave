...
namespace Dweiss
{
    ...
    public class ItemsToChange
    {
        ...
        [System.Serializable]
        public class UiButton { public GameObject go; public UiButtonType bType; }
        ...
        {
            get { return IsValid() ? button : null; }
            set { button = value; }
        }
            ...
            get
            {
                ...
                else
                {
                    if (_lastGo != go)
                    {
                        ...
                        Array.Sort(_allComponents, (a, b) => a.CompareTo(b));
                        _lastGo = go;
                    }
        ...
        public string[] AllVariables
        {
            get
            {
                ...
                else if (_lastVarCalcComponentType != ComponentType || _lastVarCalcComponentType == null)
                {
                    ...
                    Array.Sort(_allVars, (a, b) => a.CompareTo(b));
        ...
        private object Operator(object a, object b)
        {
            if (VariableType != null)
            {
                ...
                else if (VariableType == typeof(bool))
                {
                    ...
                    switch (operation)
                    {
                        case OperationType.Equal: return (bool)b;//Override with new value

                        //change value
                        case OperationType.Add: return !boolean;
                        case OperationType.Substract: return !boolean;
                        case OperationType.Mul: return !boolean;
                        case OperationType.Div: return !boolean;
                            //Default will throw exception
                    }
                }
        ...
        public object GetValue()
        {
            if (disabled)
            {
                Debug.LogError("Disabled: " + ToString(true));
                throw new System.InvalidOperationException("Object disabled");
            }

            if (IsValid() == false)
            {
                Debug.LogError(OverrideInfo(false, "Failed - configuration invalid"));
                throw new System.InvalidOperationException("Object not valid");
            }
            if (_realComp == null)
                _realComp = ComponentType == typeof(GameObject) ? go : (object)go.GetComponent(ComponentType);
            ...
            {
                Debug.LogWarning(OverrideInfo(false, "Failed"));
                throw new System.ArgumentException("Object failed");
            }
            ...
            {
                Debug.LogError("Get Type not supported " + _realMemberInfo + " by " + this);
                throw new System.ArgumentException("Object failed due to invalid type " + _realMemberInfo);
            }
        ...
        public Type[] GetMethodParamTypes()
        {
            ...
            if (_realMemberInfo.MemberT == System.Reflection.MemberTypes.Method)
            {
                return ReflectionUtils.GetMethodParamType(_realComp, _variable);
            }
            else
            {
                Debug.LogError("Get Type not supported " + _realMemberInfo + " by " + this);
        ...
        public Type GetValueType()
        {
            ...
            if (_realMemberInfo.MemberT == System.Reflection.MemberTypes.Property)
            {
                return ReflectionUtils.GetPropertyType(_realComp, _variable);
            }
            else if (_realMemberInfo.MemberT == System.Reflection.MemberTypes.Field)
            {
                return ReflectionUtils.GetFieldType(_realComp, _variable);
            }
            else
            {
                Debug.LogError("Get Type not supported " + _realMemberInfo + " by " + this);
